...
#SBATCH --job-name="steezy_set1"
#SBATCH --output=/move/u/jiamanli/github/mofitness/diffusion_motion_2d/final_cvpr25_slurm_logs/slurm_output_train_steezy_2d_w_line_cond_set1.log
